...
Finally lets create a requirements.txt file by `pip freeze > requirements.txt`


Now our project is ready for deployment

- [Deploy django app to aws](/deploy-django-to-aws.md)
- [deploy django app to heroku](/deploy-django-to-heroku.md)